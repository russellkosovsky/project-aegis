...
def test_node_receives_correct_message():
    ...
    message = Message(source_id="some_other_node", destination_id=node_a.id, payload="Test")
...
def test_node_rejects_incorrect_message():
    ...
    node_a = Node("Receiver Node")
    message = Message(source_id="some_other_node", destination_id="a_different_id", payload="Wrong")
